...
@section('content')
    <div class="mb-3">
        <x-tambah-data action="{{route('dokter.obat.create')}}" >
            ...
            <tbody>
                @foreach($obat as $o)
                    <tr>
                        ...
                        <td>
                            <x-actions id="{{$o->id}}" routeDelete="{{route('dokter.obat.delete', encryptStr($o->id))}}" routeEdit="{{route('dokter.obat.update')}}">
