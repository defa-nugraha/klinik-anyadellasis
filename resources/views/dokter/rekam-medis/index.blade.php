...
@section('content')
    <div class="mb-3">
        <a href="{{route('dokter.rekam_medis.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Rekam Medis Baru</a>
    </div>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-auto p-2">
                                    <a href="{{route('dokter.rekam_medis.detail', encryptStr($item->pasien->id))}}" class="btn btn-info">
