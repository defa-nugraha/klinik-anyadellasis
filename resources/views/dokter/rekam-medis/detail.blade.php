            ...
            <div class="d-flex justify-content-between">
                ...
                @if($statusRekamMedis)
                    @if($statusRekamMedis->status == 'antrian')
                        <a href="{{route('dokter.rekam_medis.update-status').'?rekam_medis='.encryptStr($statusRekamMedis->id).'&status=pemeriksaan'}}" class="btn btn-primary">Lanjutkan ke dokter <i class="fas fa-chevron-right"></i></a>
                    @elseif($statusRekamMedis->status == 'pemeriksaan')
                        <a href="{{route('dokter.rekam_medis.update-status').'?rekam_medis='.encryptStr($statusRekamMedis->id).'&status=di apotek'}}" class="btn btn-primary">Selesaikan pemeriksaan & perawatan <i class="fas fa-chevron-right"></i></a>
                    @elseif($statusRekamMedis->status == 'di apotek')
                        <a href="{{route('dokter.rekam_medis.update-status').'?rekam_medis='.encryptStr($statusRekamMedis->id).'&status=selesai'}}" class="btn btn-primary">Selesaikan rekam medis ini <i class="fas fa-chevron-right"></i></a>
                    @endif
                @endif
            </div>
            <x-table>
