...
@section('content')
    <div class="mb-3">
        <x-tambah-data action="{{route('nurse.antrian.create')}}" >
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-auto">
                                    @if($a->status == 'antri')
                                        <a href="{{route('nurse.antrian.proses', encryptStr($a->id))}}" class="btn btn-sm btn-warning">
                                ...
                                <div class="col-auto">
                                    <x-delete id="{{$a->id}}" route="{{route('nurse.antrian.delete', encryptStr($a->id))}}" />
                                </div>
                            </div>
                        </td>
                    </tr>
