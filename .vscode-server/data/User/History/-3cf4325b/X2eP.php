        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('nurse.dashboard')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('nurse/pasien*') ? 'active' : '' }}" href="{{route('nurse.pasien')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('nurse/antrian*') ? 'active' : '' }}" href="{{route('nurse.antrian')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('nurse/rekam_medis*') ? 'active' : '' }}" href="{{route('nurse.rekam_medis')}}" aria-expanded="false">
                <span>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="{{route('nurse.profil')}}" class="d-flex align-items-center gap-2 dropdown-item">
