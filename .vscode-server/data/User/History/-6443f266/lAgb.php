        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('apotek.dashboard')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('apotek/obat') ? 'active' : '' }}" href="{{route('apotek.obat')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('apotek/obat/resep*') ? 'active' : '' }}" href="{{route('apotek.obat.resep')}}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('apotek/obat-keluar*') ? 'active' : '' }}" href="{{route('apotek.obat-keluar')}}" aria-expanded="false">
                <span>
                  <i class="fa fa-prescription-bottle-alt"></i>
                </span>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="{{route('apotek.profil')}}" class="d-flex align-items-center gap-2 dropdown-item">
