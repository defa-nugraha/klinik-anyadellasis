...
class PasienNurseController extends Controller
{
    function index()
    {
        $data = [
        ...
        return view('nurse.pasien.index', $data);
    }
    ...
    function create()
    {
        ...
        return view('nurse.pasien.create', $data);
    }
    ...
    function edit($id)
    {
        ...
        return view('nurse.pasien.edit', $data);
    }
