...
class ObatNurseController extends Controller
{
    function index()
    {
        $data = [
        ...
        return view('nurse.obat.index', $data);
    }
    ...
    function resep()
    {
        ...
        return view('nurse.obat.resep', $data);
    }
    ...
    function createResep($id_rm)
    {
        ...
        if ($rekamMedis->status == 'selesai') {
            ...
            return redirect('nurse/obat/resep');
        }
        ...
        return view('nurse.obat.resep-create', $data);
    }
