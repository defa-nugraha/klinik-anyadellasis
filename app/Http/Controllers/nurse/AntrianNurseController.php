...
class AntrianNurseController extends Controller
{
    function index()
    {
        $data = [
        ...
        return view('nurse.antrian.index', $data);
    }
    ...
    function proses($id_antrian)
    {
        ...
        return redirect(route('nurse.rekam_medis.createFromAntrian', encryptStr($antrian->id)));
    }
}
